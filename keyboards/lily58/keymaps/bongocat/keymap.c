...
#define CAPS_SHIFT MT(MOD_LSFT, KC_CAPS)
 ...
 */
 ...
 [_QWERTY] = LAYOUT( \
	...
	CAPS_SHIFT,	KC_Z,		KC_X,	KC_C,		KC_V,	KC_B,		KC_LBRC,	KC_RBRC,	KC_N,	KC_M,		KC_COMM,	KC_DOT,		KC_SLSH,	KC_BSLS,	\
 ...
 [_COLEMAK] = LAYOUT( \
	...
	KC_LCTRL,	TD(TD_A),	KC_R,	KC_S,	KC_T,	KC_G,                   			KC_M,	KC_N,	TD(TD_E),	TD(TD_I),	TD(TD_O),		KC_QUOT, \
	CAPS_SHIFT,	KC_Z,		KC_X,	KC_C,	KC_D,	KC_V,		KC_LBRC,	KC_RBRC,	KC_K,	KC_H,	KC_COMM,	KC_DOT,		KC_SLSH,  KC_BSLS,	\
				KC_LALT,	KC_LGUI,	TD(TD_QWERTY_COLEMAK),	KC_SPC,		KC_ENT,		MO(_RAISE),	KC_BSPC,	KC_GRV \
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
