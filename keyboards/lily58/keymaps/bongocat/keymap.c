 ...
 */
 ...
 [_QWERTY] = LAYOUT( \
	...
	KC_LSFT,	KC_GRV,		KC_Z,	KC_X,	KC_C,	KC_V,		KC_LBRC,	KC_RBRC,	KC_B,	KC_N,	KC_M,	KC_COMM,	KC_DOT,		KC_SLSH,	  \
    			KC_LALT,	KC_LGUI,	TD(TD_QWERTY_COLEMAK),	KC_SPC,		KC_ENT,		MO(_RAISE),	KC_BSPC,	KC_BSLS \
),
 [_COLEMAK] = LAYOUT( \
	KC_ESC,		KC_1,		KC_2,	KC_3,	KC_4,	KC_5,                    			KC_6,	KC_7,	KC_8,	KC_9,		KC_0,		KC_MINS, \
	...
	KC_LSFT,	KC_MINS,	KC_Z,	KC_X,	KC_C,	KC_D,		KC_LBRC,	KC_RBRC,	KC_V,	KC_K,	KC_H,	KC_COMM,	KC_DOT,		KC_SLSH,  \
				KC_LALT,	KC_LGUI,	TD(TD_QWERTY_COLEMAK),	KC_SPC,		KC_ENT,		MO(_RAISE),	KC_BSPC,	KC_BSLS \
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_RAISE] = LAYOUT( \
  _______, _______, _______, _______, _______, _______,                     _______, _______, _______,      _______, _______, _______, \
  KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                        KC_6,    KC_HOME, KC_PAGE_DOWN, KC_PAGE_UP, KC_END,  _______, \
